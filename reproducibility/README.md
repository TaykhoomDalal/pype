...
`python -m pype.reproduce` reproduces the Mendelian randomization portion of the 2024 PYPE paper from public summary statistics.
...
Bootstrap standard errors for median and mode estimators vary with the random seed. Use `--seed` and `--bootstrap` for a repeatable run.
