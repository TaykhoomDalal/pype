#!/bin/bash
#SBATCH -c 1                                                                                        # Request 1 cores
#SBATCH -t 0-02:0                                                                               # Runtime in D-HH:MM format
...
if [ $1 == "-abdomen" ]; then
	python3 /home/tad368/PheWAS-and-GWAS-Diabetes-Correlation-pipeline/pheWAS_pipeline/visualize.py \
		--input ~/data_dir/AC/PheWAS_Visualization/ukbb_categories_aggregated_abdomen.tab \
		--output ~/data_dir/AC/PheWAS_Visualization/abdomen/$2/abdomen_all.png \
		--mapping category_mappings.txt \
		--gene_file ~/data_dir/AC/PheWAS_Visualization/hg19_gene_list \
	...
	python3 /home/tad368/PheWAS-and-GWAS-Diabetes-Correlation-pipeline/pheWAS_pipeline/visualize.py \
		--input ~/data_dir/AC/PheWAS_Visualization/ukbb_categories_aggregated_eyes.tab \
		--output ~/data_dir/AC/PheWAS_Visualization/eyes/$2/eyes_all.png \
		--mapping category_mappings.txt \
		--gene_file ~/data_dir/AC/PheWAS_Visualization/hg19_gene_list \
	...
	python3 /home/tad368/PheWAS-and-GWAS-Diabetes-Correlation-pipeline/pheWAS_pipeline/visualize.py \
		--input ~/data_dir/AC/PheWAS_Visualization/ukbb_categories_aggregated_heart.tab \
		--output ~/data_dir/AC/PheWAS_Visualization/heart/$2/heart_all.png \
		--mapping category_mappings.txt \
		--gene_file ~/data_dir/AC/PheWAS_Visualization/hg19_gene_list \
	...
	python3 /home/tad368/PheWAS-and-GWAS-Diabetes-Correlation-pipeline/pheWAS_pipeline/visualize.py \
		--input ~/data_dir/AC/PheWAS_Visualization/ukbb_categories_aggregated_brain.tab \
		--output ~/data_dir/AC/PheWAS_Visualization/brain/$2/brain_all.png \
		--mapping category_mappings.txt \
		--gene_file ~/data_dir/AC/PheWAS_Visualization/hg19_gene_list \
		--rsid_files ~/PheWAS-and-GWAS-Diabetes-Correlation-pipeline/variants_list/Brain/Brain_Top_SNPS.tsv \
		--rsid_files ~/PheWAS-and-GWAS-Diabetes-Correlation-pipeline/variants_list/Brain/BrainMRI_Top_SNPS.tsv \
		--plot_top_categories \
		--number_of_top_results 10 \
		$3 \
		$4
